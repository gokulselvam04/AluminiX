...
SUPABASE_ANON_KEY = os.environ.get("SUPABASE_ANON_KEY", "anon-key-placeholder")
SUPABASE_SERVICE_ROLE_KEY = os.environ.get("SUPABASE_SERVICE_ROLE_KEY", "service-role-key-placeholder")
